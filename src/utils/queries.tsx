...
export const useSnippetsOperations = () => {
  ...
  const snippetOperations: SnippetOperations = new SnippetOperationImpl();
...
> => {
  ...
  return useMutation<
    Snippet,
    Error,
    { id: string; updateSnippet: UpdateSnippet }
  >(
    ({ id, updateSnippet }) =>
      snippetOperations.updateSnippetById(id, updateSnippet),
    {
      onSuccess,
    },
  );
...
export const useShareSnippet = () => {
  ...
  return useMutation<Snippet, Error, { snippetId: string; userId: string }>(
    ({ snippetId, userId }) =>
      snippetOperations.shareSnippet(snippetId, userId),
  );
};
...
export const usePostTestCase = () => {
  ...
  return useMutation<TestCase, Error, Partial<TestCase>>(tc =>
...
export const useGetFormatRules = () => {
  ...
  return useQuery<Rule[], Error>('formatRules', () =>
...
export const useGetLintingRules = () => {
  ...
  return useQuery<Rule[], Error>('lintingRules', () =>
...
export const useFormatSnippet = () => {
  ...
  return useMutation<string, Error, string>(snippetContent =>
